...
def notebook_one() -> nbf.NotebookNode:
    ...
    nb["cells"] = [
        ...
        nbf.v4.new_markdown_cell(
            ...
            "| 主Held-out | 受領固定10-foldは各回17行をHeld outするが、同じ暫定trajectoryの近傍点は訓練側に入り得る。"
            "したがって主に既知系列内補間 |\n"
            "| 厳しいHeld-out | `file_key` 先頭4 tokenを暫定trajectoryとして丸ごとHeld out。"
            "strict 5×4 nested group CVではモデル・40/45/50°境界もinner CVだけで選ぶ |\n"
